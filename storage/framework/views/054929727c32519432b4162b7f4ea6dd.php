        ...
        <div class="card-body p-5">
            ...
            <div class="info-grid mb-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-4"><div class="info-item text-center"><strong>السعر</strong><br><h4><?php echo e(number_format($apartment->price)); ?> ل.س</h4></div></div>
                    <div class="col-md-4"><div class="info-item text-center"><strong>نوع الأجار</strong><br><h4><?php echo e(ucfirst($apartment->rent_type)); ?></h4></div></div>
